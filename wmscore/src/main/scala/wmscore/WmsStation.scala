...
/**
 * A sharded `WmsStation` has a set of recorded datapoints
...
private[wmscore] object WmsStation {
  ...
  // setup for using WmsStations through Apache Pekko Cluster Sharding
  // these could also live elsewhere and the WmsStation class be completely
